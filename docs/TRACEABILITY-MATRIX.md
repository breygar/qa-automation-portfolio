...
**Status:** Design traceability only. Every automation status is `Not Implemented`, and Automated
Test remains intentionally empty.

| Feature / Requirement           | Risk         | Scenario ID    | Scenario                                     | Priority | Automation Decision | Automation Status | Automated Test               |
| ------------------------------- | ------------ | -------------- | -------------------------------------------- | -------- | ------------------- | ----------------- | ---------------------------- |
| Authentication / valid access   | R-001        | AE-AUTH-001    | Valid registered-user sign-in                | High     | Automate            | Not Implemented   |                              |
| Authentication / invalid access | R-001        | AE-AUTH-002    | Invalid credentials rejected                 | High     | Automate            | Not Implemented   |                              |
| Authentication / session end    | R-001        | AE-AUTH-003    | Logout clears authenticated navigation       | High     | Automate            | Not Implemented   |                              |
...
| Registration / account creation | R-002        | AE-REG-001     | Unique user created and signed in            | Critical | Automate            | Not Implemented   |                              |
| Registration / uniqueness       | R-002        | AE-REG-002     | Existing email rejected                      | High     | Automate            | Not Implemented   |                              |
...
| Account / deletion              | R-003        | AE-ACCT-003    | Deleted account cannot log in                | Critical | Automate            | Not Implemented   |                              |
...
| Cart / add                      | R-005        | AE-CART-001    | One item enters cart                         | High     | Automate            | Not Implemented   |                              |
| Cart / calculations             | R-005        | AE-CART-002    | Two line items retain correct values         | Critical | Automate            | Not Implemented   |                              |
| Cart / quantity                 | R-005        | AE-CART-003    | Multi-quantity value is preserved            | High     | Automate            | Not Implemented   |                              |
| Cart / removal                  | R-005        | AE-CART-004    | Only selected line is removed                | High     | Automate            | Not Implemented   |                              |
...
All 52 designed scenarios map to at least one identified risk. Four scenarios have Phase 3
implementations; the remaining 48 retain `Not Implemented` status and empty test paths. Scenario
wording and decisions are authoritative in `TEST-SCENARIOS.md`.
